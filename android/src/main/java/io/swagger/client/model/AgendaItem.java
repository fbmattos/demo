...
public class AgendaItem {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? agendaItem.id == null : this.id.equals(agendaItem.id)) &&
        (this.name == null ? agendaItem.name == null : this.name.equals(agendaItem.name)) &&
        (this.date == null ? agendaItem.date == null : this.date.equals(agendaItem.date));
  }
