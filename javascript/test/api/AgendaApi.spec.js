...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerCon2017Api.AgendaApi();
  });
  ...
  describe('AgendaApi', function() {
    describe('agendaGet', function() {
      it('should call agendaGet successfully', function(done) {
        //uncomment below and update the code to test agendaGet
        //instance.agendaGet(pet, function(error) {
    ...
    describe('agendaPost', function() {
      it('should call agendaPost successfully', function(done) {
        //uncomment below and update the code to test agendaPost
        //instance.agendaPost(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
