...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerCon2017Api.AgendaItem();
  });
  ...
  describe('AgendaItem', function() {
    it('should create an instance of AgendaItem', function() {
      // uncomment below and update the code to test AgendaItem
      //var instane = new DockerCon2017Api.AgendaItem();
      //expect(instance).to.be.a(DockerCon2017Api.AgendaItem);
    });
