...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DockerCon2017Api.SpeakerItem();
  });
  ...
  describe('SpeakerItem', function() {
    it('should create an instance of SpeakerItem', function() {
      // uncomment below and update the code to test SpeakerItem
      //var instane = new DockerCon2017Api.SpeakerItem();
      //expect(instance).to.be.a(DockerCon2017Api.SpeakerItem);
    });
