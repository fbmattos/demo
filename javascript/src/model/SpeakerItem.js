...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DockerCon2017Api.SpeakerItem = factory(root.DockerCon2017Api.ApiClient);
  }
  ...
  /**
   * The SpeakerItem model module.
   * @module model/SpeakerItem
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SpeakerItem</code>.
   * @alias module:model/SpeakerItem
   * @class
   * @param id {String} 
   * @param name {String} 
   * @param title {String} 
   ...
   */
  var exports = function(id, name, title, profile) {
    var _this = this;
  ...
  /**
   * Constructs a <code>SpeakerItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SpeakerItem} obj Optional instance to populate.
   * @return {module:model/SpeakerItem} The populated <code>SpeakerItem</code> instance.
   */
