...
object DevelopersApi {
  ...
  def searchInventory(searchString: Option[String] = None, skip: Option[Int] = None, limit: Option[Int] = None): ApiRequest[Seq[InventoryItem]] =
    ApiRequest[Seq[InventoryItem]](ApiMethods.GET, "https://dev-virtserver.swaggerhub.com/org_test_ticket1572_2/test_ticket1579_mocking2/1.0.0", "/inventory", "application/json")
